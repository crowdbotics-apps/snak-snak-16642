...
import {invitationRequest, sendInvitationRequest, acceptRejectInvitationRequest} from './invitation-saga/invitation-saga';
...
export function* rootSaga() {
  ...
  yield fork(acceptRejectInvitationRequest);
