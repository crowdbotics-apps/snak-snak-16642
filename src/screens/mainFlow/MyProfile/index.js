...
import {Header, Button, CustomModal} from '../../../components';
          ...
          <CustomModal
            ...
            <View style={styles.modalMainContainer}>
              <TouchableOpacity
                ...
                style={styles.cancellBtnContainer}>
                <Image
                  style={styles.cancellImgStyle}
                  source={appIcons.cancell}
                />
              </TouchableOpacity>
              <View style={styles.feedBackTextMainContainer}>
                <Text style={styles.boldHeaders}>Feedback</Text>
                <Text style={styles.feedBackgreyText}>
                  Hey,was your Snaksnak with{' '}
                  <Text style={styles.feedbackgreyboldText}>Peter</Text>
                </Text>
                <Text style={styles.feedBackgreyText}>
                  Yesterday (09/07/2020) a sucessfull ?
                </Text>
              </View>
